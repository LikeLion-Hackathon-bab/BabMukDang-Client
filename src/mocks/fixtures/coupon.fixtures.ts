...
const coupon = (
    data: Omit<CouponResponse, 'couponId'> & { couponId: number }
) =>
    ({
        ...data,
        couponId: data.couponId as CouponResponse['couponId']
...
export const mockCouponResponses: CouponResponse[] = [
    coupon({
        ...
        used: true,
        thumbnailUrl: 'https://example.com/test/coupon-restaurant.png'
    }),
    coupon({
        couponId: 2,
        title: '동학 주점 음료 서비스',
